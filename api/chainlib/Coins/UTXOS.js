...
const Outpoint = require('../Transcation/outpoint');
...
class UTXOS {
    ...
    async updateFromBlock(block,coinview) {
        console.log('[UTXOS.js updateFromBlock],height='+this.currentHeight.toString()+' blockheight='+block.height.toString());
        ...
        for (let tx of block.txs) {
            ...
            for (let input of tx.inputs) {
                ...
                let outpoint = Outpoint.fromTX(tx,nIndex);
                nIndex++;
                coinview.removeEntry(outpoint);
            }
