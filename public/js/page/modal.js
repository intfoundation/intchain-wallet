...
modal.nodeList = function(obj, doc, cal) {
    ...
    if (nodes && nodes.length) {
        dom = '<div style="font-family:PingFangSC-Regular;position:fixed;left:0px;top:0px;width: 100%;height: 100%;z-index: 100px;background-color:rgba(0,0,0,0.3)">' +
            '<div style="width: 455px;margin: 200px auto;z-index: 101;border-radius: 4px">' +
        ...
        dom = '<div style="font-family:PingFangSC-Regular;position:fixed;left:0px;top:0px;width: 100%;height: 100%;z-index: 100;background-color:rgba(0,0,0,0.3)">' +
            '<div style="width: 410px;margin: 200px auto;z-index: 101;border-radius: 4px">' +
            // '<div style="color:rgba(51,51,51,1);font-size:20px; width: 100%;height: 76px;line-height:' +
            // '76px;background-color:' +
            // 'rgba(244,248,255,1);border-bottom: 1px solid #d7d7d7">' +
...
modal.showInfo = function() {
    ...
    div.setAttribute('id', 'modal');
    var dom = "<div style=\"font-family:PingFangSC-Regular;position:fixed;left:0px;top:0px;width: 100%;height:100%;z-index: 1000;background-color:rgba(0,0,0,0.3)\">\n    <div style=\"width: 700px;margin: 100px auto 0 auto;border-radius: 4px\">\n        <div style=\"color:#fff;font-size:18px;font-weight:700;width: 100%;height: 76px;line-height:\n                76px;background-color:\n                #171921;border-bottom: 1px solid #d7d7d7\">\n            <span style=\"margin-left: 32px\">" + doc.cfi + "</span>\n        </div>\n        <div style=\"font-size:14px;width: 100%;max-height:300px;overflow:auto;padding:10px 0 28px 0;background-color:\n        rgba(255,255,255,1);color:#222;border-bottom: 1px solid #d7d7d7\">";
    for (var o in obj) {
        dom += "<div style=\"margin-top: 18px;margin-left:32px\">\n                 <div style=\"display: inline-block;width: 180px;text-align: left;vertical-align: top\">" + o + ":</div>\n                 <div style=\"display: inline-block;width: 480px;text-align: left;word-break: break-all ;vertical-align: top\">\n                     " + obj[o] + "</div>\n             </div>";
    }
    dom += "</div>\n        <div style=\"font-size:16px;width: 100%;height: 68px;background-color:rgba(255,255,255,1)\">\n            <div\n                    style=\"cursor:pointer;font-size:16px;text-align:center;color:rgba(153,153,153,1);width: 48%;height: 100%;line-height:\n                    68px;display:\n                    inline-block;vertical-align: top\" onclick=\"cancel(this)\">" + doc.cancel + "</div>\n            <div    style=\"vertical-align:top;width:2px;border-left:1px solid rgba(204,204,204,1);height: 60px;display:\n                    inline-block;margin-top: 8px\"></div>\n            <div style=\"cursor:pointer;font-size:16px;text-align:center;color:green;width: 48%;height: 100%;line-height:\n                    68px;display:\n                    inline-block;vertical-align: top\" onclick=\"confirm(this)\">" + doc.confirm + "</div>\n        </div>\n    </div>\n</div>";
    div.innerHTML = dom;
    document.body.appendChild(div);
};
