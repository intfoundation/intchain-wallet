...
<head>
    <meta charset="utf-8">
    <title>Get Test Coin| INT Chain</title>
    ...
    <script type="text/javascript" src="./js/page/mapping.js"></script>
    ...
    <!-- <style>
        ...
        .out {
            height: 14px;
            width: 14px;
            border: 1px solid rgba(60, 49, 215, 1);
            border-radius: 8px;
        ...
        .in {
            height: 8px;
            width: 8px;
            background-color: rgba(60, 49, 215, 1);
            border-radius: 5px;
            margin: 3px;
            display: inline-block;
        }
        ...
        .mp-warn {
            ...
            color: #cd222d;
            font-size: 15px;
            background-color: rgba(253, 221, 155, 0.5);
            border: 1px solid;
            padding: 8px
        }
    </style> -->
    ...
    <body ng-app="myApp">
        <div class="container" ng-controller="mappingController">
                ...
                <div class="header-con">
                    ...
                    <div class="tabbar-box">
                      ...
                      <a href="./index.html?lan={{lan}}">{{doc.newWallet}}</a>
                        ...
                        <div id="vote" ng-mouseenter="voteTabView = true" ng-mouseleave="voteTabView = false" class="tab-item">
                            <span>
                                    <a href="javascript:;" >{{doc.vote}}</a>
                                <img  src="./images/voteunac.png" alt="">
                                </span>
                            <div class="b-line"></div>
                            <div class="voteTab" ng-show="voteTabView">
                                <div class="voteTab-item">
                                    <a href="./vote.html?action=Mortgage&lan={{lan}}">
                                        {{doc.mortgage}} 
                            </a>
                                </div>
                                <div class="voteTab-item">
                                    <a href="./vote.html?action=Vote&lan={{lan}}">
                                        {{doc.vote}}
                                    </a>
                                </div>
                                <div class="voteTab-item">
                                    <a href="./vote.html?action=Unmortgage&lan={{lan}}">
                                        {{doc.unmortgage}} 
                                    </a>
                                </div>
                                <div class="voteTab-item">
                                    <a href="./vote.html?action=Referendum&lan={{lan}}">
                                                        {{doc.referendum}} 
                                            </a>
                                </div>
                            </div>
                        ...
                        <div class="tab-item">
                            <span>
                                    ...
                                    <a target="_blank" href="./images/help{{lan}}.pdf">{{doc.help}}</a> 
                                </span>
                        </div>
            ...
            <div class="content">
                <div class="con-top">
                    <img style="margin-bottom:-4px" src="./images/mapping.png" alt=""><span> {{doc.mapping}}</span>
                </div>
                <div class="main">
                    <p class="mp-warn">
                        {{doc.mappingWarn}}
                    ...
                    <div>
                        <div class="item-box">
                            <div class="lable">{{doc.ethPrivateKey}}</div>
                            <div class="in-box">
                                <input ng-keyup="enterEvent($event)" type="text" placeholder="{{doc.ethPrivateKey}}" ng-model="model.fromAddressPrivateKey">
                            </div>
                        </div>

                        <div class="item-box" style="margin-left: 50px">
                            <div class="lable">{{doc.intPrivateKey}}</div>
                            <div class="in-box">
                                <input ng-keyup="enterEvent($event)" type="text" placeholder="{{doc.intPrivateKey}}" ng-model="intPrivateKey">
                            </div>
                        </div>

                        <div class="item-box">
                            <div class="lable"> {{doc.ethAdress}}</div>
                            <div class="in-box">
                                <input ng-keyup="enterEvent($event)" readonly type="text" ng-blur="queryBalance()" placeholder="{{doc.ethAdress}}" ng-model="model.fromAddress">
                            </div>
                        </div>
                        <div class="item-box" style="margin-left: 50px">
                            <div class="lable">{{doc.intAddress}}</div>
                            <div class="in-box">
                                <input ng-keyup="enterEvent($event)" readonly type="text" placeholder="{{doc.intAddress}}" ng-model="model.toAddress">
                            </div>
                        </div>
                        <div class="item-box">
                            <div class="lable">{{doc.ethBalance}}</div>
                            <div class="in-box">
                                <input ng-keyup="enterEvent($event)" readonly type="text" placeholder="{{doc.ethBalance}}" ng-model="ethBalance">
                            </div>
                        </div>
                        <div class="item-box" style="margin-left: 50px">
                            <div class="lable">{{doc.intBalance}}</div>
                            <div class="in-box">
                                <input ng-keyup="enterEvent($event)" readonly type="text" placeholder="{{doc.intBalance}}" ng-model="model.decimalAmount">
                            </div>
                        </div>
                        <div class="item-box">
                            <div class="lable">Gas Price</div>
                            <div class="in-box">
                                <input ng-keyup="enterEvent($event)" type="text" placeholder="Gas Price" ng-model="model.decimalGas">
                            </div>
                        </div>
                        <div class="item-box" style="margin-left: 50px">
                            <div class="lable">Gas Limit</div>
                            <div class="in-box">
                                <input ng-keyup="enterEvent($event)" type="text" placeholder="Gas Limit" ng-model="model.gasLimit">
                            </div>
                        </div>
                        <div class="btn-dis" style="margin-top: 48px" ng-show="!pass">{{doc.mapping}}</div>
                        <div ng-click="toMapping()" ng-show="pass" class="btn-unlock" style="margin-top: 48px">
                            {{doc.mapping}}
                        </div>
